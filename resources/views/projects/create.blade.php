    ...
    <div class="max-w-2xl">
        <form action="{{ route('projects.store') }}" method="POST"
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Website Redesign"
            ...
            <div>
                ...
                <textarea name="description" rows="3" placeholder="Deskripsi singkat project ini..."
                    class="w-full rounded-xl border border-[#ECECE9] bg-[#FAFAF8]
                             focus:border-blue-500 focus:ring-2 focus:ring-blue-100
